...
BOT_TOKEN = environ.get('BOT_TOKEN', '5947317301:AAEbykmawRZElYZra1JY9xsld8g3JO3AJCA')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://m:m@cluster0.olkznba.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

#maximum search result buttos count in number#
MAX_RIST_BTNS = int(environ.get('MAX_RIST_BTNS', "10"))
START_MESSAGE = environ.get('START_MESSAGE', f"{script.START_TXT}")
